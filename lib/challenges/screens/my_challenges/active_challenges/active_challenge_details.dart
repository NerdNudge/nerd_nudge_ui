...
class MyActiveChallengeDetails extends StatefulWidget {
  const MyActiveChallengeDetails({super.key, required this.challenge});

  final Map<String, dynamic> challenge;

  @override
  State<MyActiveChallengeDetails> createState() =>
      _MyActiveChallengeDetailsState();
}

class _MyActiveChallengeDetailsState extends State<MyActiveChallengeDetails> {
  @override
